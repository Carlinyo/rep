...
let ChatGateway = class ChatGateway {
    ...
    async joinedUsername(socket, data) {
        ...
        socket.emit("joinedUser", Message);
        socket.broadcast.emit("joinedUser", Message);
    }
};
__decorate([
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_j = typeof socket_io_1.Socket !== "undefined" && socket_io_1.Socket) === "function" ? _j : Object, typeof (_k = typeof joined_user_emtity_1.JoinedUserMessage !== "undefined" && joined_user_emtity_1.JoinedUserMessage) === "function" ? _k : Object]),
    __metadata("design:returntype", Promise)
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("3a3ef010b68b058967b6")
/******/ })();
/******/ 
/******/ }
;