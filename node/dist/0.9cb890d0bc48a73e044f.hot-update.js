...
let ChatGateway = class ChatGateway {
    ...
    onInput(socket, data) {
        if (data) {
            console.log(data);
            socket.broadcast.emit("typing", { active: "true" });
        }
        else {
            console.log(data, 2);
            socket.broadcast.emit("typing", { active: "false" });
        }
    }
};
__decorate([
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_h = typeof socket_io_1.Socket !== "undefined" && socket_io_1.Socket) === "function" ? _h : Object, String]),
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("cda9e081cdae96823727")
/******/ })();
/******/ 
/******/ }
;