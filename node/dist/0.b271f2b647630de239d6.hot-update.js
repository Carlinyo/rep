...
let ChatService = class ChatService {
    ...
    async updateUser(data) {
        let currUser = await this.users.find({ where: { username: data.data.to_email } });
        let user = await this.users.createQueryBuilder().update(this.users).set({
            token: data.token
        })
            .where('');
    }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("3015c506e9ab6772f95c")
/******/ })();
/******/ 
/******/ }
;