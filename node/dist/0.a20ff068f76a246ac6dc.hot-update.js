...
let ChatGateway = class ChatGateway {
    ...
    async joinedUser(socket, username) {
        username && socket.emit('username', username + ' is joined');
    }
};
__decorate([
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ChatGateway.prototype, "joinedUser", null);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("a7d6f63a54e8633ac0b2")
/******/ })();
/******/ 
/******/ }
;