...
let ChatGateway = class ChatGateway {
    ...
    async onInput(socket, data) {
        let groupData = await this.chatService.GetGroupData(data.group);
        console.log(groupData);
        if (data.typing) {
            socket.broadcast.to(data.group).emit("typing", "true");
        }
        else {
            socket.broadcast.to(data.group).emit("typing", "false");
        }
    }
};
__decorate([
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("f32b9c1fde29f534893f")
/******/ })();
/******/ 
/******/ }
;