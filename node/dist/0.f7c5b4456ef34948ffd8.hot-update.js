...
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_entity_1.User, (user) => user, { onDelete: "NO ACTION", onUpdate: "NO ACTION" }),
...
__decorate([
    ...
    (0, typeorm_1.JoinColumn)(),
    __metadata("design:type", typeof (_b = typeof groups_entity_1.groups !== "undefined" && groups_entity_1.groups) === "function" ? _b : Object)
], JoinedUserMessage.prototype, "group", void 0);
__decorate([
    (0, typeorm_1.Column)(),
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("707ee372d826cc9af213")
/******/ })();
/******/ 
/******/ }
;