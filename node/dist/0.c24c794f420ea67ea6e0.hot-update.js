...
let ChatGateway = class ChatGateway {
    ...
    async joinedUsername(socket, data) {
        ...
        let message = { message: data.user + " is joined", date };
        let Message = await this.chatService.sendJoinedUserMessages(message);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("f7183ccebabab84042a0")
/******/ })();
/******/ 
/******/ }
;