...
let RegisterService = class RegisterService {
    ...
    async JoinToGroup(user) {
        let User = this.dataSource.getRepository(groups_entity_1.groups).createQueryBuilder('groups').where('user.groupId = :groupId', { groupId: user.groupId });
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("97307fe8c2f286bef604")
/******/ })();
/******/ 
/******/ }
;