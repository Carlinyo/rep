...
let ChatGateway = class ChatGateway {
    ...
    async getGroupData(data) {
        let Data = await this.chatService.GetGroupData();
    }
    sendMessage(message) {
...
__decorate([
    (0, websockets_1.SubscribeMessage)('getgroupData'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_d = typeof groupmessages_entity_1.GroupsMessages !== "undefined" && groupmessages_entity_1.GroupsMessages) === "function" ? _d : Object]),
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("6ccdc8c5fcd053a9d9d8")
/******/ })();
/******/ 
/******/ }
;