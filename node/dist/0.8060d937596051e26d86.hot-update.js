...
let ChatGateway = class ChatGateway {
    ...
    async getUsers(socket) {
        let users = await this.chatService;
    }
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_e = typeof socket_io_1.Socket !== "undefined" && socket_io_1.Socket) === "function" ? _e : Object, typeof (_f = typeof sendMessageTypes !== "undefined" && sendMessageTypes) === "function" ? _f : Object]),
    __metadata("design:returntype", Promise)
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("1b0dae0ef07a48d6bda3")
/******/ })();
/******/ 
/******/ }
;