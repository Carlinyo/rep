...
let ChatGateway = class ChatGateway {
    ...
    async handleDisconnect(socket) {
        socket.emit("imDisconected", "sdasdasdwd");
    }
    ...
    async disconnected(socket, data) {
    }
};
__decorate([
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_l = typeof socket_io_1.Socket !== "undefined" && socket_io_1.Socket) === "function" ? _l : Object, String]),
    __metadata("design:returntype", Promise)
], ChatGateway.prototype, "disconnected", null);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("3b968342f33fc9e9a7ea")
/******/ })();
/******/ 
/******/ }
;