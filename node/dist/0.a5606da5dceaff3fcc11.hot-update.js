...
let ChatService = class ChatService {
    ...
    async findUser(data) {
        console.log(data);
        let user = await this.users.update({ token: data.token }, { verification: 1, password: await bcrypt.hash(data.data.password, 10) });
    }
};
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("c7300f59a29b8ea9ea08")
/******/ })();
/******/ 
/******/ }
;