...
const groupmessage_dto_1 = __webpack_require__(29);
...
let ChatService = class ChatService {
    constructor(users, group_user, Groups, GroupMessages, messages, ) {
        this.users = users;
    ...
    async sendGroupMessage(body) {
        ...
        let gMessage = await this.gMessages.save({
            message: Message.id,
            from: body.from,
            group: body.group,
        });
    ...
    async JoinToGroup(user) {
        ...
        for (let i = 0; i < groupUsers.length; i++) {
            if (groupUsers[i].username === user.group.username) {
                ...
                contains = 1;
                return {
                    status: user.group.username + "_" + Math.round(Math.random() * 100),
                };
            }
        }
...
ChatService = __decorate([
    ...
    __param(4, (0, typeorm_1.InjectRepository)(messages_entity_1.Messages)),
    __param(5, (0, typeorm_1.InjectRepository)(groupmessage_dto_1.GroupMessagesI)),
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.GroupMessagesI = void 0;
class GroupMessagesI {
}
exports.GroupMessagesI = GroupMessagesI;
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("ff1507be2bb1549145c9")
/******/ })();
/******/ 
/******/ }
;