...
let ChatGateway = class ChatGateway {
    ...
    async joinedUsername(socket, data) {
        ...
        let message = { message: data.user + " is joined", date: date };
        this.chatService;
        console.log(message);
    }
};
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_j = typeof socket_io_1.Socket !== "undefined" && socket_io_1.Socket) === "function" ? _j : Object, typeof (_k = typeof sendMessageTypes !== "undefined" && sendMessageTypes) === "function" ? _k : Object]),
    __metadata("design:returntype", Promise)
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("6c8ab5d346b384e799e6")
/******/ })();
/******/ 
/******/ }
;