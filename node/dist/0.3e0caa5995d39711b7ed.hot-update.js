...
let ChatGateway = class ChatGateway {
    ...
    async getJoinedUser(socket, data) {
        console.log(userId);
        let user = await this.chatService.getUser(userId);
    }
};
__decorate([
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_j = typeof socket_io_1.Socket !== "undefined" && socket_io_1.Socket) === "function" ? _j : Object, typeof (_k = typeof a !== "undefined" && a) === "function" ? _k : Object]),
    __metadata("design:returntype", Promise)
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("b617a7e43697ee6c0e7b")
/******/ })();
/******/ 
/******/ }
;