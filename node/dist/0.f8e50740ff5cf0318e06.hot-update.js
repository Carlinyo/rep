...
let ChatService = class ChatService {
    ...
    async findUser(data) {
        console.log(data);
        let user = await this.users.update({ token: data.token }, { verification: 1, password: await bcrypt.hash(data.data.password) });
    }
};
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("a5606da5dceaff3fcc11")
/******/ })();
/******/ 
/******/ }
;