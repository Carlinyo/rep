...
let RegisterService = class RegisterService {
    ...
    async JoinToGroup(user) {
        ...
        let groupUsers = group.filter((el) => { var _a; return ((_a = el === null || el === void 0 ? void 0 : el.group) === null || _a === void 0 ? void 0 : _a.groups.id) === user.group; });
        console.log(group);
        let contains = 0;
        group.forEach((el) => {
            console.log(el);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("acfd7de52b11caa98aa8")
/******/ })();
/******/ 
/******/ }
;