...
const joined_user_messages_dto_1 = __webpack_require__(25);
let ChatGateway = class ChatGateway {
    ...
    async deleteUser(socket, id) {
        if (id) {
            await this.chatService.LogoutUser(id);
        }
    }
...
__decorate([
    (0, websockets_1.SubscribeMessage)('disconnected', m),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_k = typeof socket_io_1.Socket !== "undefined" && socket_io_1.Socket) === "function" ? _k : Object, typeof (_l = typeof joined_user_messages_dto_1.JoinedUserMessagesDto !== "undefined" && joined_user_messages_dto_1.JoinedUserMessagesDto) === "function" ? _l : Object]),
    __metadata("design:returntype", Promise)
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("990f3645aa00d808fe52")
/******/ })();
/******/ 
/******/ }
;