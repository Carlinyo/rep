...
let RegisterService = class RegisterService {
    ...
    async JoinToGroup(user) {
        ...
        let group = await this.users.find({ where: { groupsId: user.group }, relation: ['group'] });
        console.log(group);
        let contains = 0;
        group.forEach((el) => {
        ...
        if (group.length < 5 && contains === 0) {
            ...
            this.group_user.save({ groupsId: user.group, group: user.group, user: User.id });
            return group;
        }
        else {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("58f776eb1375fb40221c")
/******/ })();
/******/ 
/******/ }
;