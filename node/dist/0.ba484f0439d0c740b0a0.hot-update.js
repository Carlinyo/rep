...
let RegisterService = class RegisterService {
    ...
    async JoinToGroup(user) {
        ...
        let group = await this.users.find({ where: { group: user.groupId }, relation: ['group'] });
        console.log(group);
        let contains = 0;
        group.forEach((el) => {
        ...
        if (group.length < 5 && contains === 0) {
            ...
            this.group_user.save({ group: user.groupId, user: User.id });
            return group;
        }
        else {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("85e69e8d969d229cc4bb")
/******/ })();
/******/ 
/******/ }
;