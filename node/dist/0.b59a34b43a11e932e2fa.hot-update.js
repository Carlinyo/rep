...
let RegisterService = class RegisterService {
    ...
    async JoinToGroup(user) {
        ...
        let Group = await this.Groups.findBy({ id: user.groupId });
        let Users = await this.Groups.forEach((el) => {
        });
        if (user_entity_1.User) {
            return user_entity_1.User.name + '_' + user_entity_1.User.id;
        }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("0751d53a4aa48d347694")
/******/ })();
/******/ 
/******/ }
;