...
let ChatService = class ChatService {
    ...
    async LogoutUser(id) {
        let user = await this.users.find({ where: { id: id } });
        let groupUser = await this.group_user.find({ relations: { user: true } });
        let GroupUser = groupUser.find((el) => el.user.id === +id);
        console.log(GroupUser);
        await this.group_user.delete(Gro);
    }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("a254572641cfbdea0cf2")
/******/ })();
/******/ 
/******/ }
;