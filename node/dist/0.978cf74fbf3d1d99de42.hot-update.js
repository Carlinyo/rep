...
let ChatService = class ChatService {
    ...
    async getGroupMessages(group) {
        return await this.gMessages.findBy({ group });
    }
    async sendGroupMessage(message) {
        await this.messages.save({ message: message.message, date: message.date });
        await this.gMessages.save({ from: message.from, group: message.group });
    }
};
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("7a8f11e2021d4feac0db")
/******/ })();
/******/ 
/******/ }
;