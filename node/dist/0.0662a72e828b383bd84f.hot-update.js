...
let RegisterService = class RegisterService {
    ...
    async registerUser(user) {
        con;
        await this.User.create({ id: user.id, username: user.username, lastName: user.lastName, firstName: user.firstName, email: user.email, active: user.active, groupId: user.groupId });
    }
    async getGroups() {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("57fc99a4f41ed7955b71")
/******/ })();
/******/ 
/******/ }
;