...
const user_dto_1 = __webpack_require__(27);
...
let ChatService = class ChatService {
    ...
    async LogoutUser(id) {
        ...
        if (groupUser) {
            await this.group_user.delete(groupUser).then(async () => {
            });
        }
        async;
        JoinToGroup(user, (common_1.RawBodyRequest));
        {
        ...
        async;
        leaveGroup(id, user_dto_1.UserDto);
        {
        ...
        async;
        sendJoinedUserMessages(message, joined_user_messages_dto_1.JoinedUserMessagesDto);
        {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("17981bd19f24f87df408")
/******/ })();
/******/ 
/******/ }
;