...
let ChatService = class ChatService {
    ...
    async LogoutUser(id) {
        ...
        console.log(user);
        let groupUser = await this.group_user.find({ where: { user: id } });
        console.log(groupUser);
        await this.group_user.delete({ where: { user: id } });
        await this.users.delete({ where: { id: id } });
    }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("03c0191fb428ed52b9b2")
/******/ })();
/******/ 
/******/ }
;