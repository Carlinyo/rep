...
let ChatGateway = class ChatGateway {
    ...
    async createUser(socket, data, token) {
        let users = await this.chatService.getUsers();
        if (users.every((el) => el.user.username !== data.to_email)) {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_m = typeof socket_io_1.Socket !== "undefined" && socket_io_1.Socket) === "function" ? _m : Object, Object, String]),
    __metadata("design:returntype", Promise)
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("a812b7d5f5d3910c7f02")
/******/ })();
/******/ 
/******/ }
;