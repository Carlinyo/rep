...
let ChatGateway = class ChatGateway {
    ...
    async handleDisconnect(socket) {
        let user = await this.group_user.findOne({}, { user: socket.id });
    }
    ;
};
__decorate([
...
handleNewMessage(chat, sendMessageTypes, socket, socket_io_1.Socket);
{
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("d4681316dd5496ca962f")
/******/ })();
/******/ 
/******/ }
;