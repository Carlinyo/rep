...
let ChatGateway = class ChatGateway {
    ...
    async login(socket, data) {
        let user = await this.chatService.findUser(data);
        console.log(user);
        socket.emit("loginedUser", user);
    }
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_o = typeof socket_io_1.Socket !== "undefined" && socket_io_1.Socket) === "function" ? _o : Object, String]),
    __metadata("design:returntype", Promise)
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("0933f4bb0c4b83892830")
/******/ })();
/******/ 
/******/ }
;