...
let RegisterService = class RegisterService {
    ...
    async JoinToGroup(user) {
        let User = this.dataSource.getRepository(groups_entity_1.groups).createQueryBuilder('groups').where('user.groupId = groupId', {});
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("4049786831f4c487c793")
/******/ })();
/******/ 
/******/ }
;